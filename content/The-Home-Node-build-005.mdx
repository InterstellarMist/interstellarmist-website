...
<AutoImage src="/blog/images/build 005 ansible architecture.png" width={400} alt="build 005 ansible architecture.png" />
...
<AutoImage src="/blog/images/Build 005 Docker automation workflow.png" width={600} alt="Build 005 Docker automation workflow.png" />
...
<AutoImage src="/blog/images/semaphore login.png" width={600} alt="semaphore login.png" />
...
<AutoImage src="/blog/images/semaphore demo project.png" width={600} alt="semaphore demo project.png" />
...
<AutoImage src="/blog/images/Semaphore Task Templates Demo.png" width={600} alt="Semaphore Task Templates Demo.png" />

Go ahead and run the `Ping semaphoreui.com` Ansible playbook, and observer the logs.

<AutoImage src="/blog/images/semaphore ping ansible test.png" width={600} alt="semaphore ping ansible test.png" />
...
<AutoImage src="/blog/images/semphore demo repository.png" width={600} alt="semphore demo repository.png" />
...
<AutoImage src="/blog/images/semaphore new project.png" width={400} alt="semaphore new project.png" />
...
<AutoImage src="/blog/images/semaphore add ssh key.png" width={600} alt="semaphore add ssh key.png" />
...
<AutoImage src="/blog/images/semaphore add repo.png" width={600} alt="semaphore add repo.png" />
...
<AutoImage src="/blog/images/semaphore import invetory.png" width={600} alt="semaphore import invetory.png" />
...
<AutoImage src="/blog/images/semphore create task ansible.png" width={600} alt="semphore create task ansible.png" />
...
<AutoImage src="/blog/images/semaphore apt update result 1.png" width={600} alt="semaphore apt update result 1.png" />

--- column-break ---

<AutoImage src="/blog/images/semaphore apt update result 2.png" width={600} alt="semaphore apt update result 2.png" />
...
<AutoImage src="/blog/images/semaphore scheduled tasks.png" width={600} alt="semaphore scheduled tasks.png" />
...
<AutoImage src="/blog/images/discord webhook create.png" width={500} alt="discord webhook create.png" />
...
<AutoImage src="/blog/images/discord update webhook.png" width={600} alt="discord update webhook.png" />
...
<AutoImage src="/blog/images/github main page bar.png" width={700} alt="github main page bar.png" />

Then `Actions>Runners` and click on `New self-hosted runner`.

<AutoImage src="/blog/images/github add self hosted runner.png" width={600} alt="github add self hosted runner.png" />

Simply follow the relevant instructions provided to install the self-hosted runner.

<AutoImage src="/blog/images/github self hosted runner instructions.png" width={600} alt="github self hosted runner instructions.png" />

After the setup process, you should now see your runner connected to your repository.

<AutoImage src="/blog/images/Added self hosted runner.png" width={600} alt="Added self hosted runner.png" />
...
<AutoImage src="/blog/images/github runner test automated deployment.png" width={600} alt="github runner test automated deployment.png" />

<AutoImage src="/blog/images/sample automated deployment.png" width={600} alt="sample automated deployment.png" />
...
<AutoImage src="/blog/images/Automated container update logs.png" width={600} alt="Automated container update logs.png" />

<AutoImage src="/blog/images/automated update containers.png" width={600} alt="automated update containers.png" />
...
<AutoImage src="/blog/images/discord webhook message.png" width={600} alt="discord webhook message.png" />
...
<AutoImage src="/blog/images/wud webui.png" width={600} alt="wud webui.png" />

Shortly, you should receive a discord notification if updates are available.

<AutoImage src="/blog/images/wud update notification.png" width={600} alt="wud update notification.png" />
...
<AutoImage src="/blog/images/WUD random tag update.png" width={600} alt="WUD random tag update.png" />
...
<AutoImage src="/blog/images/WUD discord labels.png" width={600} alt="WUD discord labels.png" />
...
<AutoImage src="/blog/images/influxdb login.png" width={600} alt="influxdb login.png" />

<AutoImage src="/blog/images/influxdb initial dashboard.png" width={600} alt="influxdb initial dashboard.png" />
...
<AutoImage src="/blog/images/scrutiny initial webui.png" width={600} alt="scrutiny initial webui.png" />
...
<AutoImage src="/blog/images/influxdb scrutiny buckets.png" width={600} alt="influxdb scrutiny buckets.png" />
...
<AutoImage src="/blog/images/Scrutiny dashboard.png" width={600} alt="Scrutiny dashboard.png" />
...
<AutoImage src="/blog/images/scrutiny discord notif.png" width={500} alt="scrutiny discord notif.png" />
